var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            description: "The streamflow that supplies Vancouver’s watershed runs on a hybrid hydroclimatic regime, where the bulk of the streamflow is sourced from both precipitation and snowmelt. The highest volume of streamflow is during the months of September to December which is sourced by frontal storms. During the months of April to August, the streamflow is sourced by snowmelt from the Coastal Mountains. The streamflow from snowmelt is greatest during the spring and decreases throughout the summer and therefore leading to water scarcity during the summer months.",
            location: {
                center: [-122.94145, 49.43662],
                zoom: 11.12,
                pitch: 42,
                bearing: 179.20,
                speed: 0.2,
